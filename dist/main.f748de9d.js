...
var SimpleifyUrl = function SimpleifyUrl(url) {
...
var render = function render() {
  ...
  map.forEach(function (node, index) {
    console.log(index);
    var $li = $("<li>     \n          <div class=\"site\">\n            <div class=\"logo\">".concat(node.logo, "</div>\n            <div class=\"link\">").concat(SimpleifyUrl(node.url), "</div>\n            <div class=\"close\">\n            <svg class=\"icon\" aria-hidden=\"true\">\n                <use xlink:href=\"#icon-close1\"></use>\n              </svg></div>\n          </div>\n        </li>")).insertBefore($lastLi);
...
$(".addButton").on("click", function () {
  var url = window.prompt("请输入想要添加的网站");
...
//# sourceMappingURL=main.f748de9d.js.map